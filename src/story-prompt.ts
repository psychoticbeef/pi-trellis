...
const PLACEMENT_GATE_RECOVERY = `Placement-Gate-Fehler: Nennt trellis Kandidaten, rufe create_node nicht erneut auf. Forme Kandidaten in neue nummerierte placement proposals um, nenne gaps und warte auf neue User-Auswahl. Erst danach darfst du create_node kind=story mit gewählter activity und slice aufrufen.`;
...
Bitte User um Auswahl einer Nummer oder Korrektur. Vor ausdrücklicher Auswahl kein create_node. Erstelle danach ausschließlich gewählte Story oder gewählte zwei Stories via create_node kind=story; übergib jeweils gewählte activity und slice. Ergänze bestätigte Given/When/Then-Kriterien via add_acceptance_criterion.
